...
(function () {
    ...
    function renderFromValues(progressSeconds, durationSeconds) {
        ...
        if (currentTimeElement)
            currentTimeElement.textContent = formatTimeInMinutesAndSeconds(boundedProgress);
        if (totalTimeElement)
            totalTimeElement.textContent = formatTimeInMinutesAndSeconds(boundedDuration);
    }
