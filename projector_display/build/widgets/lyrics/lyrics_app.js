...
(() => {
  ...
  (function() {
    ...
    let hideTransitionTimeoutHandle = null;
    ...
    function enterInterTrackBridge(context) {
      ...
      bridgeSourceIndex = currentActiveIndex !== null && currentActiveIndex >= 0 ? currentActiveIndex : resolvedActive >= 0 ? resolvedActive : uiLines.length > 0 ? uiLines.length - 1 : -1;
    ...
    function hide(onHiddenCallback) {
      ...
      hideElement.ontransitionend = function(event) {
