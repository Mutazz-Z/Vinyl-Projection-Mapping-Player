...
(function (WidgetState) {
    WidgetState[WidgetState["Hide"] = 0] = "Hide";
    WidgetState[WidgetState["Show"] = 1] = "Show";
    WidgetState[WidgetState["Pause"] = 2] = "Pause";
    WidgetState[WidgetState["Resume"] = 3] = "Resume";
    WidgetState[WidgetState["Loading"] = 4] = "Loading";
    WidgetState[WidgetState["Idle"] = 5] = "Idle";
    WidgetState[WidgetState["EjectRecord"] = 6] = "EjectRecord";
})(WidgetState || (WidgetState = {}));
export var MediaPlaybackState;
(function (MediaPlaybackState) {
    MediaPlaybackState[MediaPlaybackState["Playing"] = 0] = "Playing";
    MediaPlaybackState[MediaPlaybackState["Paused"] = 1] = "Paused";
    MediaPlaybackState[MediaPlaybackState["Idle"] = 2] = "Idle";
    MediaPlaybackState[MediaPlaybackState["Buffering"] = 3] = "Buffering";
    MediaPlaybackState[MediaPlaybackState["Unknown"] = 4] = "Unknown";
    MediaPlaybackState[MediaPlaybackState["Stopped"] = 5] = "Stopped";
    MediaPlaybackState[MediaPlaybackState["Error"] = 6] = "Error";
    MediaPlaybackState[MediaPlaybackState["Offline"] = 7] = "Offline";
...
export class TrackLyrics_t {
    ...
    toJson() {
        return {
            ...
            'lines': this.lines.map(function (element) { return element.toJson(); }),
        };
    }
}
...
export class QueueList_t {
    ...
    toJson() {
        return {
            'tracks': this.tracks.map(function (element) { return element.toJson(); }),
...
export class VinylRecordTagData_t {
    ...
    static fromJson(json) {
        ...
        return new VinylRecordTagData_t({
            ...
            artist: typeof json['artist'] === 'string' ? json['artist'] : '',
            trackList: Array.isArray(json['track_list']) ? json['track_list'].map((element) => AlbumTrackList_t.fromJson(element)) : [],
            coverImage: typeof json['cover_image'] === 'string' ? json['cover_image'] : '',
    ...
    toJson() {
        return {
            ...
            'artist': this.artist,
            'track_list': this.trackList.map(function (element) { return element.toJson(); }),
            'cover_image': this.coverImage,
